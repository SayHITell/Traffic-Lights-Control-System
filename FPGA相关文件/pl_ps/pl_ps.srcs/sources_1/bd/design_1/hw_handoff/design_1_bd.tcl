...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set BTN_RSTn [ create_bd_port -dir I -type rst BTN_RSTn ]
  set C [ create_bd_port -dir O C ]
  set CLK [ create_bd_port -dir I -type clk CLK ]
  set Color_Sig [ create_bd_port -dir O -from 2 -to 0 Color_Sig ]
  set Color_Sub_Sig [ create_bd_port -dir O -from 1 -to 0 Color_Sub_Sig ]
  set RSTn [ create_bd_port -dir I -type rst RSTn ]
  set Scan_Sig [ create_bd_port -dir O -from 6 -to 0 Scan_Sig ]

  # Create instance: PMOD_SSD_v1_0_0, and set properties
  set PMOD_SSD_v1_0_0 [ create_bd_cell -type ip -vlnv Archer:user:PMOD_SSD_v1_0:1.0 PMOD_SSD_v1_0_0 ]
...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins PMOD_SSD_v1_0_0/s_axi] [get_bd_intf_pins processing_system7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net BTN_RSTn_1 [get_bd_ports BTN_RSTn] [get_bd_pins PMOD_SSD_v1_0_0/BTN_RSTn]
  connect_bd_net -net CLK_1 [get_bd_ports CLK] [get_bd_pins PMOD_SSD_v1_0_0/CLK]
  connect_bd_net -net PMOD_SSD_v1_0_0_C [get_bd_ports C] [get_bd_pins PMOD_SSD_v1_0_0/C]
  connect_bd_net -net PMOD_SSD_v1_0_0_Color_Sig [get_bd_ports Color_Sig] [get_bd_pins PMOD_SSD_v1_0_0/Color_Sig]
  connect_bd_net -net PMOD_SSD_v1_0_0_Color_Sub_Sig [get_bd_ports Color_Sub_Sig] [get_bd_pins PMOD_SSD_v1_0_0/Color_Sub_Sig]
  connect_bd_net -net PMOD_SSD_v1_0_0_Scan_Sig [get_bd_ports Scan_Sig] [get_bd_pins PMOD_SSD_v1_0_0/Scan_Sig]
  connect_bd_net -net RSTn_1 [get_bd_ports RSTn] [get_bd_pins PMOD_SSD_v1_0_0/RSTn]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins PMOD_SSD_v1_0_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_0_100M/ext_reset_in]
  connect_bd_net -net rst_processing_system7_0_100M_interconnect_aresetn [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins rst_processing_system7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins PMOD_SSD_v1_0_0/s_axi_aresetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs PMOD_SSD_v1_0_0/s_axi/reg0] SEG_PMOD_SSD_v1_0_0_reg0
